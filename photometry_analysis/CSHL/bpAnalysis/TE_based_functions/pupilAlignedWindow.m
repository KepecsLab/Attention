function [data, xData] = pupilAlignedWindow(TE, trials, varargin)
...
%% process zeroTimes and windows
    ...
    zeroTimes = zeroTimes - TE.pupil.startTime; % redefine zero times relative to photometry start
...
%         if Photometry.settings.uniformOutput
            trialData = Pupil.(s.FluorDataField)(trial, :);
%         else
%             % FINISH CODING!!!!
